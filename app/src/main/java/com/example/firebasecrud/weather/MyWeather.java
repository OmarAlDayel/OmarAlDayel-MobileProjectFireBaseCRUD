package com.example.firebasecrud.weather;
...
public class MyWeather extends AppCompatActivity {
    ...
    String City = "London";
    //Your Key
    String Key = "29d0025d8122c56fd607beeb88faf536";
    ...
    public void loading(View view) {
        ...
        MyWeather.DownloadTask downloadTask = new DownloadTask();
        ...
        try {
            ...
            MyWeather.DownloadImage downloadImage = new DownloadImage();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChangeCity = findViewById(R.id.changeCityBtn);
        buttonChangeCity.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), WeatherActivity.class));
        });


        if (Constants.isNEW_CITY_SELECTED) {
            City = Constants.NEW_CITY;
        } else {
            City = "Athens";
        }
