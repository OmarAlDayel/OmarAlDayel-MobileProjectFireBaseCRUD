...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_USER_AGE = "user_email";
    ...
    private final String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_AGE + " TEXT," + COLUMN_USER_NUMBER + " TEXT" + ")";
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_NUMBER, user.getPhone_number());
        // Inserting Row
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setUser_age(cursor.getString(cursor.getColumnIndex(COLUMN_USER_AGE)));
                user.setPhone_number(cursor.getString(cursor.getColumnIndex(COLUMN_USER_NUMBER)));
        ...
        db.close();
        // return user list
        Constants.userArrayList = userList;
        return userList;
    }
    ...
    public boolean checkUser(String email) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        // selection criteria
        String selection = COLUMN_USER_AGE + " = ?";
        // selection argument
    ...
    public boolean checkUser(String email, String password) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        // selection criteria
        String selection = COLUMN_USER_AGE + " = ?" + " AND " + COLUMN_USER_ID + " = ?";
        // selection arguments
